...
Namespace Warpfusion.A4PP.Services
    ...
    Public Class ManagementService
        ...
        Public Function GetProjectOwnerByProjectOwnerId(ByVal ProjectOwnerId As Long) As ProjectOwner
            ...
            If rs_ProjectOwner.HasRows Then
                ...
                If rs_ProjectOwner("PaymentStartDate") Is DBNull.Value Then
                    result.PaymentStartDate = GetFirstDayOfWeek(TimeZoneInfo.ConvertTime(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("New Zealand Standard Time"))).AddDays(-28)
                Else
        ...
        ''' </summary>
        Public Function GetFirstDayOfWeek(dayInWeek As DateTime) As DateTime
            Dim defaultCultureInfo As New CultureInfo("en-NZ")
        ...
        ''' is in. 
        ''' </summary>
        Public Function GetFirstDayOfWeek(dayInWeek As DateTime, cultureInfo As CultureInfo) As DateTime
            Dim firstDay As DayOfWeek = cultureInfo.DateTimeFormat.FirstDayOfWeek
            Dim firstDayInWeek As DateTime = dayInWeek.[Date]
        ...
        Public Function CreateTimesheetEntry(ByVal TimesheetEntry As TimesheetEntry) As Long
            ...
            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "CreateTimesheetEntryWithJob"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            ...
            End If
            If TimesheetEntry.JobId = Nothing Then
                m_SqlCommand.Parameters.AddWithValue("@JobId", DBNull.Value)
            Else
                m_SqlCommand.Parameters.AddWithValue("@JobId", TimesheetEntry.JobId)
            End If
            conn.Open()
            m_SqlDataAdapter = New SqlDataAdapter(m_SqlCommand)
        ...
        Public Sub SaveTimesheetEntry(ByVal TimesheetEntry As TimesheetEntry)
            Dim objTimesheetEntry As TimesheetEntry = GetTimesheetEntryByPartyAPartyBJobIdEntryDate(TimesheetEntry.PartyA, TimesheetEntry.PartyB, TimesheetEntry.EntryDate, TimesheetEntry.JobId)
        ...
        Public Sub CreateMobJobSheet(ByVal UserId As Integer, CustomerName As String, Address As String, FormanOnsite As String,
                                     PhoneNo As String, ByVal JobDate As DateTime, ByVal JobDescription As String, picFile As Byte(),
                                     picText As String, MaterialsUsed As String, JobHours As Decimal)

            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "CreateMobJobSheet"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            m_SqlCommand.Parameters.AddWithValue("@UserId", UserId)
            m_SqlCommand.Parameters.AddWithValue("@CustomerName", CustomerName)
            m_SqlCommand.Parameters.AddWithValue("@Address", Address)


            m_SqlCommand.Parameters.AddWithValue("@FormanOnsite", FormanOnsite)
            m_SqlCommand.Parameters.AddWithValue("@PhoneNo", PhoneNo)
            m_SqlCommand.Parameters.AddWithValue("@JobDate", JobDate)


            m_SqlCommand.Parameters.AddWithValue("@JobDescription", FormanOnsite)
            m_SqlCommand.Parameters.AddWithValue("@picFile", picFile)
            m_SqlCommand.Parameters.AddWithValue("@picText", picText)

            m_SqlCommand.Parameters.AddWithValue("@MaterialsUsed", FormanOnsite)
            m_SqlCommand.Parameters.AddWithValue("@JobHours", JobHours)
        ...
        Public Function CRUDMobActivity(ByVal UserId As Integer, ProjectID As Integer, JobID As Integer,
                                   param1 As String, param2 As String, ByVal param3 As String,
                                   ByVal param4 As String, ByVal param5 As String, picFile As Byte(),
                                     picText As String, Flag As String) As DataTable
            Dim result As DataSet = New DataSet()
            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "CRUDMobActivity"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            m_SqlCommand.Parameters.AddWithValue("@UserId", UserId)
            m_SqlCommand.Parameters.AddWithValue("@ProjectID", ProjectID)
            m_SqlCommand.Parameters.AddWithValue("@JobID", JobID)
            m_SqlCommand.Parameters.AddWithValue("@param1", param1)
            m_SqlCommand.Parameters.AddWithValue("@param2", param2)
            m_SqlCommand.Parameters.AddWithValue("@param3", param3)
            m_SqlCommand.Parameters.AddWithValue("@param4", param4)
            m_SqlCommand.Parameters.AddWithValue("@param5", param5)

            m_SqlCommand.Parameters.AddWithValue("@picFile", picFile)
            m_SqlCommand.Parameters.AddWithValue("@picText", picText)

            m_SqlCommand.Parameters.AddWithValue("@Flag", Flag)
            conn.Open()

            m_SqlDataAdapter = New SqlDataAdapter(m_SqlCommand)
            m_SqlDataAdapter.Fill(result, "CRUDMobActivity")
        ...
        Public Sub CreateMobReorder(ByVal UserId As Integer, JobID As String, Reorder As String, ByVal CompanyID As Integer)

            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "CreateMobReorder"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            m_SqlCommand.Parameters.AddWithValue("@UserId", UserId)
            m_SqlCommand.Parameters.AddWithValue("@JobID", JobID)
            m_SqlCommand.Parameters.AddWithValue("@Reorder", Reorder)
            m_SqlCommand.Parameters.AddWithValue("@CompanyID", CompanyID)
        ...
        Public Sub DeleteTimesheetEntry(ByVal TimesheetEntry As TimesheetEntry)
            Dim result As Long = 0
            Dim dsTimesheetEntry As DataSet = New DataSet()
            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "DeleteTimesheetEntryWithJob"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
        ...
        Public Function GetTimesheetEntryByPartyAPartyBJobIdEntryDate(ByVal PartyA As Long, ByVal PartyB As Long, ByVal EntryDate As DateTime, ByVal JobId As Long) As TimesheetEntry
            Dim result As TimesheetEntry = Nothing
            Dim rs_TimesheetEntry As SqlDataReader
            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "GetTimesheetEntryByPartyAPartyBJobIdEntryDate"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            m_SqlCommand.Parameters.AddWithValue("@PartyA", PartyA)
            m_SqlCommand.Parameters.AddWithValue("@PartyB", PartyB)
            m_SqlCommand.Parameters.AddWithValue("@EntryDate", EntryDate)
        ...
        Public Function GetTimesheetEntryByPartyAPartyBJobEntryDateRange(ByVal PartyA As Long, ByVal PartyB As Long, ByVal StartDate As DateTime, ByVal EndDate As DateTime, ByVal JobID As Long) As DataSet
            Dim result As DataSet = New DataSet()
            Dim conn As SqlConnection = m_SQLConn.conn()
            m_SqlCommand = New SqlCommand(m_SQL, conn)
            m_SqlCommand.CommandText = "GetTimesheetEntryByPartyAPartyBJobIDEntryDateRange"
            m_SqlCommand.CommandType = Data.CommandType.StoredProcedure
            m_SqlCommand.Parameters.AddWithValue("@PartyA", PartyA)
            m_SqlCommand.Parameters.AddWithValue("@PartyB", PartyB)
            m_SqlCommand.Parameters.AddWithValue("@StartDate", StartDate)
        ...
        Function CRUDMobActivity(m_UserID As Integer, ProjectID As Integer, JobID As Integer, param1 As String, param2 As String, param3 As String, param4 As String, param5 As String, p9 As Byte, picText As String, Flag As String) As DataSet
